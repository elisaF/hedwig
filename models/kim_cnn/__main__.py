...
def run_main(args):
    ...
    if args.dataset not in dataset_map:
        ...
        if args.evaluate_dev:
            train_iter, dev_iter = dataset_map[args.dataset].iters_dev(args.data_dir, path_dir, args.word_vectors_file,
                                                                       args.word_vectors_dir,
                                                                       batch_size=args.batch_size, device=device,
                                                                       unk_init=UnknownWordVecCache.unk)
        if args.evaluate_test:
            
                train_iter, test_iter = dataset_map[args.dataset].iters_test(args.data_dir, path_dir, args.word_vectors_file,
                                                                              args.word_vectors_dir,
