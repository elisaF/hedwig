...
def run_main(args):
    ...
    if args.dataset not in dataset_map:
        ...
        if args.evaluate_dev:
            train_iter, dev_iter = dataset_map[args.dataset].iters_dev(args.data_dir, data_path=path_dir,
        ...
        if args.evaluate_test:
                ...
                train_iter, test_iter = dataset_map[args.dataset].iters_test(args.data_dir, data_path=path_dir,
                                                                             vectors_name=args.word_vectors_file,
                                                                             vectors_cache=args.word_vectors_dir,
